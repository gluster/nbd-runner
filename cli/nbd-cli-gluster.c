...
struct cli_cmd gluster_cmds[] = {
    ...
    {.pattern = "gluster create <VOLUME/FILEPATH> [prealloc] <size SIZE> <host CONTROL_HOST>",
    ...
    {.pattern = "gluster delete <VOLUME/FILEPATH> <host CONTROL_HOST>",
     .call    = gluster_delete_routine,
     .desc    = "Delete FILEPATH from the VOLUME",
    },
    {.pattern = "gluster map <VOLUME/FILEPATH> [nbd-device] [timeout TIME] [readonly] <host CONTROL_HOST>",
